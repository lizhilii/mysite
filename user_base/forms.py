...
class RegForm(forms.Form):
    ...
    password = forms.CharField(
        ...
        min_length=6,
        widget=forms.PasswordInput(
            attrs={'class':'form-control','placeholder':'请输入不小于6位的密码'}
            )
        )
    ...
    def __init__(self, *arg, **kwargs):
        ...
        super(RegForm, self).__init__(*arg, **kwargs)
...
class ChangeNicknameForm(forms.Form):
    ...
    def __init__(self, *arg, **kwargs):
        ...
        super(ChangeNicknameForm, self).__init__(*arg, **kwargs)
...
class BindEmailForm(forms.Form):
    ...
    def __init__(self, *arg, **kwargs):
        ...
        super(BindEmailForm, self).__init__(*arg, **kwargs)
...
class ForgotPasswordForm(forms.Form):
    ...
    def __init__(self, *arg, **kwargs):
        ...
        super(ForgotPasswordForm, self).__init__(*arg, **kwargs)
